...
struct CheckCooldown
{
	DWORD Cooldown;
	DWORD Delay;
};

struct CheckEggCooldown
{
	DWORD EggCooldown;
	DWORD EggDelay;
};
...
time_t uptimestart; int BofConfigRead = 0, ImpConfigRead = 0, TotalBlock = 0, Lisans = 0, NailKill = 0;
...
std::map<int,CheckCooldown> CooldownTable;
std::map<int,CheckEggCooldown> EggCooldownTable;
