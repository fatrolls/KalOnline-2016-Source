...
void IChatbox::HookCommand()
{
	...
	Tools->Intercept(ITools::_I_CALL, (void*)0x0064677E, Hooks::KCommand::ProcessCommand, 5);
	Tools->Intercept(ITools::_I_CALL, (void*)0x006DDA05, Hooks::KCommand::ProcessCommand, 5);
}
