			...
			if (pTarget && IPlayer.IsOnline())
			{
				...
				while(Around)
				{
					...
					if (Object.IsValid() && IPlayer.IsValid() && (*(int (__thiscall **)(int, int, DWORD))(*(DWORD *)IPlayer.GetOffset() + 176))((int)IPlayer.GetOffset(), (int)Object.GetOffset(), 0))
					{
						...
						if (Object.GetType() == 1 && Object.GetMobTanker() && Object.GetMobTanker() != (int)IPlayer.GetOffset())
							Object.SetMobHostility(0);

						IPlayer.OktayDamageArea(Object,nDmg,42);

						if (Object.IsValid() && Object.GetType() == 1 && Object.GetMobTanker() == (int)IPlayer.GetOffset())
							Object.SetMobHostility(nDmg*4);
					}
