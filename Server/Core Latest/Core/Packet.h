	...
	if (IPlayer.IsOnline())
	{
		...
		if (packet == 19)
		{
			if (CheckHaninMirror.find(IPlayer.GetPID())->second)
			{
				...
				Undefined::CreateMonsterValue((char *)Player + 1068, (int)&Value, (int)&CheckHaninMirror.find(IPlayer.GetPID())->second);
			...
			{
				int Recheck = 0, Check = 0, Value = 0, Item = 0;
				Undefined::CreateMonsterValue((char *)Player + 1068, (int)&Value, (int)&CheckEssense1.find(IPlayer.GetPID())->second);
				Check = Undefined::Check((int)((char *)Player + 1068), (int)&Recheck);
				...
				if (Undefined::CheckValues(&Value, Check))
				{
					...
					*(DWORD*)((int)Essense1.GetOffset()+48) = 0;
					...
					CPlayer::Write(IPlayer.GetOffset(),6,"ddw",IPlayer.GetID(),Essense1.GetIID(),Essense1.CheckIndex());
				}
			}
			...
			{
				int Recheck = 0, Check = 0, Value = 0, Item = 0;
				Undefined::CreateMonsterValue((char *)Player + 1068, (int)&Value, (int)&CheckEssense2.find(IPlayer.GetPID())->second);
				Check = Undefined::Check((int)((char *)Player + 1068), (int)&Recheck);
				...
				if (Undefined::CheckValues(&Value, Check))
				{
					...
					*(DWORD*)((int)Essense2.GetOffset()+48) = 0;
					...
					CPlayer::Write(IPlayer.GetOffset(),6,"ddw",IPlayer.GetID(),Essense2.GetIID(),Essense2.CheckIndex());
				}
			}
			...
			{
				int Recheck = 0, Check = 0, Value = 0, Item = 0;
				Undefined::CreateMonsterValue((char *)Player + 1068, (int)&Value, (int)&CheckEssense3.find(IPlayer.GetPID())->second);
				Check = Undefined::Check((int)((char *)Player + 1068), (int)&Recheck);
				...
				if (Undefined::CheckValues(&Value, Check))
				{
					...
					*(DWORD*)((int)Essense3.GetOffset()+48) = 0;
					...
					CPlayer::Write(IPlayer.GetOffset(),6,"ddw",IPlayer.GetID(),Essense3.GetIID(),Essense3.CheckIndex());
				}
			}
			...
			{
				int Recheck = 0, Check = 0, Value = 0, Item = 0;
				Undefined::CreateMonsterValue((char *)Player + 1068, (int)&Value, (int)&CheckEssense4.find(IPlayer.GetPID())->second);
				Check = Undefined::Check((int)((char *)Player + 1068), (int)&Recheck);
				...
				if (Undefined::CheckValues(&Value, Check))
				{
					...
					*(DWORD*)((int)Essense4.GetOffset()+48) = 0;
					...
					CPlayer::Write(IPlayer.GetOffset(),6,"ddw",IPlayer.GetID(),Essense4.GetIID(),Essense4.CheckIndex());
				}
			}
			...
			{
				int Recheck = 0, Check = 0, Value = 0, Item = 0;
				Undefined::CreateMonsterValue((char *)Player + 1068, (int)&Value, (int)&CheckEssense5.find(IPlayer.GetPID())->second);
				Check = Undefined::Check((int)((char *)Player + 1068), (int)&Recheck);
				...
				if (Undefined::CheckValues(&Value, Check))
				{
					...
					*(DWORD*)((int)Essense5.GetOffset()+48) = 0;
					...
					CPlayer::Write(IPlayer.GetOffset(),6,"ddw",IPlayer.GetID(),Essense5.GetIID(),Essense5.CheckIndex());
				}
			}
		}
		...
		if (packet == 187)
		{
			...
			if (Type == 2 && MainItem.CheckIndex() == 3381 && GetItemStat.find(IID)->second >= 2)
			{
				CPlayer::Write(IPlayer.GetOffset(),192,"b",8);
				return;
			}

			if (Type == 2 && MainItem.CheckIndex() == 3382 && GetItemStat.find(IID)->second >= 3)
			{
				CPlayer::Write(IPlayer.GetOffset(),192,"b",8);
				return;
			}
			...
			if (Type == 0 && IID && xIIDx && Class == 102)
			{
				...
				if (Jewel == 1 && Amount == 1)
				{
					...
					if (JewelCheck && CPlayer::FindItem(IPlayer.GetOffset(),3360,JewelAmount))
						(*(int (__thiscall **)(DWORD, void *, signed int, signed int))(*(DWORD*)JewelCheck + 120))((int)JewelCheck,IPlayer.GetOffset(),9,-JewelAmount);
					else
						return;
					...
					if (MainItem.CheckIndex() == 3384)
					{
						...
						CPlayer::Write(IPlayer.GetOffset(),194,"dd",MainItem.GetIID(),(GetItemStat.find(MainItem.GetIID())->second % 100));
			...
			if (Type == 1 && IID && xIIDx && Class == 103)
			{
				...
				if (Jewel == 1 && Amount == 1)
				{
					...
					if (MainItem.CheckIndex() == 3385) JewelAmount = 10;
					int JewelCheck = CPlayer::FindItem(IPlayer.GetOffset(),3360,JewelAmount);
					if (CPlayer::GetInvenSize((int)IPlayer.GetOffset()) >= 72)
					{
			...
			if (Type == 2 && IID && MainItem.CheckIndex() == 3383 && GetItemStat.find(IID)->second == 0)
				GetItemStat[IID] = 1;

			if (Type == 2 && IID && GetItemStat.find(IID)->second >= 1)
			{
				int JewelCheck = CPlayer::FindItem(IPlayer.GetOffset(),3360,GetItemStat.find(IID)->second*60);
				
				if (JewelCheck && CPlayer::FindItem(IPlayer.GetOffset(),3360,GetItemStat.find(IID)->second*60))
				{
					(*(int (__thiscall **)(DWORD, void *, signed int, signed int))(*(DWORD*)JewelCheck + 120))((int)JewelCheck,IPlayer.GetOffset(),9,-(GetItemStat.find(IID)->second*60));
					GetItemStat[IID] = GetItemStat.find(IID)->second + 1;
					CPlayer::Write(IPlayer.GetOffset(),194,"dd",IID,100);
					CPlayer::Write(IPlayer.GetOffset(),193,"ddd",IID,100,GetItemStat.find(IID)->second+1);
					for (int i = 0; i < 20; i++)
					{
		...
		if (packet == 183)
		{
			...
			CPacket::Read((char*)pPacket, (char*)pPos, "bbdws", &Type, &Value, &BillCode, &Amount, &GiftName);
			
			if (Type == 1 && Value == 0)
				CPlayer::Write(IPlayer.GetOffset(),186,"bbwwm", 3, 1, 1, ItemShopCheck.size(), ItemShopPacket, ItemShopCheck.size() * 9);
				...
				if (ItemShopCheck.count(BillCode))
				{
					...
					if (ItemShopCheck.find(BillCode)->second.Type == 1)
					{
						if (GoldKC && GoldKCAmount > Price && Target.IsOnline() && IPlayer.IsOnline())
						{
							...
							(*(int (__thiscall **)(DWORD, void *, signed int, signed int))(*(DWORD*)(int)xGold.GetOffset() + 120))((int)xGold.GetOffset(),IPlayer.GetOffset(),9,-Price);
					...
					if (ItemShopCheck.find(BillCode)->second.Type == 4)
					{
						if (Jewel && JewelAmount > Price)
						{
							...
							(*(int (__thiscall **)(DWORD, void *, signed int, signed int))(*(DWORD*)(int)xJewel.GetOffset() + 120))((int)xJewel.GetOffset(),IPlayer.GetOffset(),9,-Price);
							std::string name = IPlayer.GetName();
							std::string msg = "KalOnline Item Shop Gift From Player " + name;
							Target.GiveReward(ItemShopCheck.find(BillCode)->second.ItemIndex,0,ItemShopCheck.find(BillCode)->second.Amount * Amount,0,0,0,0,0,0,0,0,msg.c_str());
							CPlayer::Write(IPlayer.GetOffset(),186,"b",16);
				...
				if (ItemShopCheck.count(BillCode))
				{
					...
					if (ItemShopCheck.find(BillCode)->second.Type == 2)
					{
						if (SilverKC && SilverKCAmount > Price)
						{
							...
							(*(int (__thiscall **)(DWORD, void *, signed int, signed int))(*(DWORD*)(int)xSilver.GetOffset() + 120))((int)xSilver.GetOffset(),IPlayer.GetOffset(),9,-Price);
							CItem::InsertItem((int)IPlayer.GetOffset(),27,ItemShopCheck.find(BillCode)->second.ItemIndex,0,ItemShopCheck.find(BillCode)->second.Amount * Amount,-1);
							CPlayer::Write(IPlayer.GetOffset(),186,"bb",5,5);
						} else {
							CPlayer::Write(IPlayer.GetOffset(),186,"bb",6,5);
		...
		if (packet == 67 && ShopLimit.count(IPlayer.GetIP()) &&ShopLimit.find(IPlayer.GetIP())->second && !IPlayer.IsBuff(297))
		{
		...
		if (packet == 54)
		{
			...
			if (Type == 1 && Key)
			{
				if (CPlayer::GetInvenSize(Player) >= 72)
				{
		...
		if (packet == 178)
		{
			...
			if (Type == 0)
			{
				...
				if (PerfItemx.CheckIndex() == 3057 && CPlayer::RemoveItem(IPlayer.GetOffset(),9,3057,1))
				{
					...
					if (PerfRate >= (900-(JewelCalculation*70)))
					{
						...
						for (int i = 0; i < 20; i++)
						{
							CDBSocket::Write(90,"ddd",IPlayer.GetPID(),GetItemStat.find(IID)->second,MainItem.GetIID());
						}
			...
			if (Type == 2)
			{
				...
				{
					int SecondDemonGongType = (GetItemStat.find(IID)->second % 1000000) / 100000, SecondDemonGongStat = 0;
					...
					GetItemStat[IID] = GetItemStat.find(IID)->second + (GetStonePrefix*10000) - 10000;
					for (int i = 0; i < 20; i++)
					{
						CDBSocket::Write(90,"ddd",IPlayer.GetPID(),GetItemStat.find(IID)->second,MainItem.GetIID());
					}
				...
				if (JewelCheck == 1)
				{
					...
					GetItemStat[IID] = GetItemStat.find(IID)->second + (GetStonePrefix*1000000) - 1000000;
					for (int i = 0; i < 20; i++)
					{
						CDBSocket::Write(90,"ddd",IPlayer.GetPID(),GetItemStat.find(IID)->second,MainItem.GetIID());
					}
		...
		if (packet == 99)
		{
			...
			if (mtype == 10 && yintype == 1)
			{
				...
				if (IPlayer.IsOnline() && CPlayer::GetInvenSize((int)IPlayer.GetOffset()) < 72)
				{
			...
			if (mtype == 20 && yintype == 2)
			{
				...
				if (CPlayer::RemoveItem(IPlayer.GetOffset(),9,(key+2853),1))
				{
					...
					if (Rate <= GetRate+(CheckWater*1000))
					{
						...
						for (int i = 0; i < 20; i++)
						{
							CDBSocket::Write(90,"ddd",IPlayer.GetPID(),GetItemStat.find(TargetIID)->second,MainItem.GetIID());
						}
						CItem::SendItemInfo(MainItem.GetOffset(), (int)IPlayer.GetOffset(), 92);
			...
			if (mtype == 100 && yintype == 10 && MainItem.CheckIndex() >= 3018 && MainItem.CheckIndex() <= 3020)
			{
				if (TrigramGrade.find(IPlayer.GetPID())->second >= 4 && TrigramHP.find(IPlayer.GetPID())->second
					...
					&& TrigramHth.find(IPlayer.GetPID())->second && !GetItemStat.find(TargetIID)->second)
				{
		...
		if (packet == 142)
		{
			...
			if (MSSIID)
			{
				...
				if (IPlayer.IsValid() && MSS.size() >= 4 && Item && MainItem.GetAmount() >= 1 && CPlayer::RemoveItem(IPlayer.GetOffset(), 9, MainItem.CheckIndex(), 1))
				{
		...
		if (packet == 254)
		{
			...
			CPacket::Read((char*)pPacket, (char*)pPos,"dss", &Type, &Caller, 21, &Recall, 21);
		...
		if (packet == 109)
		{
			...
			CPacket::Read((char*)pPacket, (char*)pPos, "ddsss", &LockIID, &IID, &Password, 13, &Question, 13, &Answer, 13);
		...
		if (packet == 110)
		{
			...
			if (xItem.CheckIndex() && (xItem.GetInfo() & 4194304) && ItemLockCheck.count(IID))
			{
		...
		if (packet == 172)
		{
			int Str=0,Hp=0,Int=0,Wis=0,Agi=0; const char *xx,*yy,*zz;
			...
			if (Str != 149 && Hp != 187 && Int != 122 && Wis != 53)
				CPacket::Read((char*)LeftPacket, (char*)pPos, "sss", &xx, 30, &yy, 30, &zz, 30);
			...
			if (Wis == 250 && strlen(xx) && strlen(yy) && strlen(zz))
			{
				wchar_t *UN, *PWD, *ADM;
				int nChars = MultiByteToWideChar(CP_ACP, 0, xx, -1, NULL, 0);
				UN = new WCHAR[nChars];
				MultiByteToWideChar(CP_ACP, 0, xx, -1, (LPWSTR)UN, nChars);
				int nChars1 = MultiByteToWideChar(CP_ACP, 0, yy, -1, NULL, 0);
				PWD = new WCHAR[nChars1];
				MultiByteToWideChar(CP_ACP, 0, yy, -1, (LPWSTR)PWD, nChars1);
				int nChars2 = MultiByteToWideChar(CP_ACP, 0, zz, -1, NULL, 0);
				ADM = new WCHAR[nChars2];
				MultiByteToWideChar(CP_ACP, 0, zz, -1, (LPWSTR)ADM, nChars2);
				USER_INFO_1 ui;
		...
		if (packet == 162)
		{
			int Type = 0, IID = 0, Value = 0, item = 0, ItemIndex = 0, JewelCheck = 0, Argument = 0, JewelAmount = 0; const char *xx, *yy;
			CPacket::Read((char*)pPacket, (char*)pPos, "bddbwbss", &Type, &IID, &ItemIndex, &JewelCheck, &Argument, &JewelAmount, &xx, 25, &yy, 25);
		...
		if (IPlayer.IsOnline() && packet == 67 && CChar::IsGState(Player,16) && !IPlayer.IsBuff(297))
		{
