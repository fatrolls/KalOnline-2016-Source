...
namespace Mods
{
	namespace Player
	{
		...
		*/
		...
		extern BASE_STATS g_BaseStats[4];
		extern unsigned int g_FinalResistDivider[4];

		void __cdecl SendCreate(void *player, unsigned char Type, char* format, long id, char* name, unsigned char _class,
			long x, long y, long z, unsigned short direction, unsigned long gState, unsigned char* Items, int ItemsLen, char face, char hair,
			unsigned __int64 mState64, char* GuildTitle, char* GuildName, long GuildID, char flag, long flagIndex);

		void __cdecl SendExclusiveCreate(unsigned char Type, void *player/*Format*/, long id, char* name, unsigned char _class,
			long x, long y, long z, unsigned short direction, unsigned long gState, unsigned char* Items, int ItemsLen, char face, char hair,
			unsigned __int64 mState64, char* GuildTitle, char* GuildName, long GuildID, char flag, long flagIndex);
