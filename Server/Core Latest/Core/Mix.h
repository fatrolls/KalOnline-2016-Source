signed int __stdcall MixItemCheck(int MainItem, int Weapon, int Armor)
{
	...
	if (*(DWORD*)(*(DWORD*)(MainItem + 40) + 80) == 70 || *(DWORD*)(*(DWORD*)(MainItem + 40) + 80) == 75 || *(DWORD*)(*(DWORD*)(MainItem + 40) + 80) == 80)
	{
...
int __fastcall Imperial(void *pPlayer, void *edx, int MainItem, int Armor, int Stone, int Weapon, int NextStone)
{
	...
	*(DWORD*)&MixCheck = 0;
	...
	if (success == false)
	{
		if (!(*(int (__thiscall **)(DWORD, void *, signed int, signed int))(**((DWORD**)pPlayer + 274) + 120))(*((DWORD *)pPlayer + 274),pPlayer,9,-70000))
		...
		case 0x4B:
			...
			} else if ( *(DWORD *)(*(DWORD *)(d + 40) + 96) )
			{
				if ( *(DWORD *)(*(DWORD *)(d + 40) + 96) == 1 && Itemd.CheckIndex() == 1917 )
					...
					Imp = 1926;
				else if ( *(DWORD *)(*(DWORD *)(d + 40) + 96) == 1 && Itemd.CheckIndex() == 4325 )
					Imp = 4332;
				else if ( *(DWORD *)(*(DWORD *)(d + 40) + 96) == 1 && Itemd.CheckIndex() == 4326 )
					Imp = 4333;
				else if ( *(DWORD *)(*(DWORD *)(d + 40) + 96) == 1 && Itemd.CheckIndex() == 4327 )
					Imp = 4334;
				else if ( Itemd.CheckIndex() == 4324 )
					Imp = 4331;
				else
					Imp = 1923;
			} else {
				if ( Itemd.CheckIndex() == 1914 )
					Imp = 1921;
				else if ( Itemd.CheckIndex() == 4322 )
					Imp = 4329;
				else if ( Itemd.CheckIndex() == 4323 )
					Imp = 4330;
				else
					Imp = 1922;
			}
...
int __fastcall EnforceItem(void *pPlayer, void *edx, int MixLevel, int ItemIndex, int DemonSword, int Item, int NextItem, char Stone)
{
	...
	*(DWORD*)&MixCheck = 0;
	...
	if ( success == false )
	{
		if ( !(*(int (__thiscall **)(DWORD, void *, signed int, signed int))(**((DWORD**)pPlayer + 274) + 120))(*((DWORD *)pPlayer + 274),pPlayer,9,-30000) )
			CPlayer::_OutOfInven(IPlayer.GetOffset(),*((DWORD *)pPlayer + 274));
