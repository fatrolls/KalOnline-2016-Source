...
int __fastcall MyArmorGetGrade(int a, void *edx)
{
	...
	if (check)
		CheckArmorGrade = *(DWORD *)(check + 272);
...
void BofFix()
{
	...
	Tools->Intercept(ITools::_I_CALL, (void*)0x004A2747, MyArmorGetGrade, 5);
	Tools->Intercept(ITools::_I_CALL, (void*)0x004A2859, BofStatFix, 5);
}
