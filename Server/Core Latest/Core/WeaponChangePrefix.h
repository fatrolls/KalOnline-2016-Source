signed int __fastcall WeaponChangePrefix(void *Item, void *edx, int Player, int ID, int Chance, int Argument)
{
	...
	if (CurrentPrefix == NewPrefix)
	{
		...
		if (NewPrefix == ImpConfigRead)
		{
			...
			{
			case 0x28:
				if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 3 )
				{
					Imp = 1433;
			...
			case 0x4B:
				...
				} else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) )
				{
					if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1 && IItem.CheckIndex() == 1917 )
						...
						Imp = 1926;
					else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1 && IItem.CheckIndex() == 4325 )
						Imp = 4332;
					else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1 && IItem.CheckIndex() == 4326 )
						Imp = 4333;
					else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1 && IItem.CheckIndex() == 4327 )
						Imp = 4334;
					else if ( IItem.CheckIndex() == 4324 )
						Imp = 4331;
					else
						Imp = 1923;
				} else {
					if ( IItem.CheckIndex() == 1914 )
						Imp = 1921;
					else if ( IItem.CheckIndex() == 4322 )
						Imp = 4329;
					else if ( IItem.CheckIndex() == 4323 )
						Imp = 4330;
					else
						Imp = 1922;
				}
