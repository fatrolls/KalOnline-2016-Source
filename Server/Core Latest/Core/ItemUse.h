int __fastcall ItemUse(void *ItemOffset, void *edx, int PlayerOffset)
{
	...
	if (IPlayer.IsOnline() && ((Item.CheckIndex() >= 3412 && Item.CheckIndex() <= 3419) || (Item.CheckIndex() >= 4149 && Item.CheckIndex() <= 4153) || (Item.CheckIndex() >= 4156 && Item.CheckIndex() <= 4160)) && CChar::IsGState((int)IPlayer.GetOffset(),4))
		return Item.GetAmount();

	if (IPlayer.IsOnline() && ((Item.CheckIndex() >= 3412 && Item.CheckIndex() <= 3419) || (Item.CheckIndex() >= 4149 && Item.CheckIndex() <= 4153) || (Item.CheckIndex() >= 4156 && Item.CheckIndex() <= 4160)) && CChar::IsGState((int)IPlayer.GetOffset(),512))
		return Item.GetAmount();

	if (IPlayer.IsOnline() && ((Item.CheckIndex() >= 3412 && Item.CheckIndex() <= 3419) || (Item.CheckIndex() >= 4149 && Item.CheckIndex() <= 4153) || (Item.CheckIndex() >= 4156 && Item.CheckIndex() <= 4160)) && (IPlayer.IsBuff(18) || IPlayer.IsBuff(19) || IPlayer.IsBuff(313) || IPlayer.IsBuff(329)))
		return Item.GetAmount();

	if (IPlayer.IsOnline() && ((Item.CheckIndex() >= 3412 && Item.CheckIndex() <= 3419) || (Item.CheckIndex() >= 4149 && Item.CheckIndex() <= 4153) || (Item.CheckIndex() >= 4156 && Item.CheckIndex() <= 4160)) && !IPlayer.IsBuff(349))
	{
		if (IPlayer.IsValid())
		{
