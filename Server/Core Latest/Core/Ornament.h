...
int __cdecl NewItem(int Value)
{
	if (*(DWORD *)(Value + 68) == -1)
	{
		...
		if ((int)GetPointer)
		{
			...
			if ((xItem.CheckIndex() >= 1747 && xItem.CheckIndex() <= 1762) || (xItem.CheckIndex() >= 1870 && xItem.CheckIndex() <= 1877) || (xItem.CheckIndex() >= 2004 && xItem.CheckIndex() <= 2007) || (xItem.CheckIndex() >= 2421 && xItem.CheckIndex() <= 2423) || (xItem.CheckIndex() >= 2550 && xItem.CheckIndex() <= 2653))
			{
	...
	if (Player.IsOnline())
	{
		if (Player.IsBuff(256))
		{
			...
			if (Item.CheckIndex() >= 3384 && Item.CheckIndex() <= 3386 && CheckHaninMirror.find(Player.GetPID())->second)
			{
				...
				if (CheckEssense1.find(Player.GetPID())->second) TotalSlotSize += 1;
				if (CheckEssense2.find(Player.GetPID())->second) TotalSlotSize += 1;
				if (CheckEssense3.find(Player.GetPID())->second) TotalSlotSize += 1;
				if (CheckEssense4.find(Player.GetPID())->second) TotalSlotSize += 1;
				if (CheckEssense5.find(Player.GetPID())->second) TotalSlotSize += 1;
			...
			if (((Item.CheckIndex() >= 1747 && Item.CheckIndex() <= 1762) || (Item.CheckIndex() >= 1870 && Item.CheckIndex() <= 1877) || (Item.CheckIndex() >= 2004 && Item.CheckIndex() <= 2007) || (Item.CheckIndex() >= 2421 && Item.CheckIndex() <= 2423) || (Item.CheckIndex() >= 2550 && Item.CheckIndex() <= 2653)) && !PetLifeCheck.count(Item.GetIID()))
			{
...
int __fastcall OrnamentPutOff(void *Itemx, void *edx, int Playerx)
{
	...
	if (Player.IsOnline())
	{
		if (Player.IsBuff(256))
		{
			...
			if (Item.CheckIndex() >= 3381 && Item.CheckIndex() <= 3383 && (CheckEssense1.find(Player.GetPID())->second || CheckEssense2.find(Player.GetPID())->second || CheckEssense3.find(Player.GetPID())->second || CheckEssense4.find(Player.GetPID())->second || CheckEssense5.find(Player.GetPID())->second))
				return 0;
			...
			if (Item.CheckIndex() >= 3384 && Item.CheckIndex() <= 3386 && CheckHaninMirror.find(Player.GetPID())->second)
			{
				...
				int MpPoint = ((Wis+2*Wis*Wis)/100), MinMAtk = ((7*Int-20)/12)+(Wis/7), MaxMAtk = (7*Int/12)+(14*Wis/45);
				...
				if (Stat && Mirror.CheckIndex() == 3381)
				{
					...
					if (Type == 5) Player.RemoveOTP(((Otp*Stat)/100)+0.5);
					if (Type == 6) Player.RemoveEva(((Eva*Stat)/100)+0.5);
					if (Type == 7) Player.RemoveDef(Stat+0.5);
					if (Type == 10) Player.DecreaseMaxHp(((HpPoint*Stat)/100)+0.5);
					if (Type == 11) Player.DecreaseMaxMp(((MpPoint*Stat)/100)+0.5);
					if (Type == 12) Player.DecreaseMovingSpeed((3*Stat)+0.5);
					if (Type == 13) Player.RemoveMinAttack(((MinPAtk*Stat)/100)+0.5);
					if (Type == 14) Player.RemoveMaxAttack(((MaxPAtk*Stat)/100)+0.5);
					if (Type == 15) Player.DecreaseCritRate((Stat/3)+0.5);
					if (Type == 16) Player.DecreaseCritDamage((Stat/2)+0.5);
					if (Type == 18) Player.RemoveMinAttack(((MinMAtk*Stat)/100)+0.5);
					if (Type == 19) Player.RemoveMaxAttack(((MaxMAtk*Stat)/100)+0.5);
				...
				if (Stat && Mirror.CheckIndex() == 3382)
				{
					...
					if (Type == 5) Player.RemoveOTP(((Otp*Stat)/90)+0.5);
					if (Type == 6) Player.RemoveEva(((Eva*Stat)/90)+0.5);
					if (Type == 7) Player.RemoveDef(Stat+1.5);
					if (Type == 10) Player.DecreaseMaxHp(((HpPoint*Stat)/90)+0.5);
					if (Type == 11) Player.DecreaseMaxMp(((MpPoint*Stat)/90)+0.5);
					if (Type == 12) Player.DecreaseMovingSpeed((3*Stat)+1.5);
					if (Type == 13) Player.RemoveMinAttack(((MinPAtk*Stat)/90)+0.5);
					if (Type == 14) Player.RemoveMaxAttack(((MaxPAtk*Stat)/90)+0.5);
					if (Type == 15) Player.DecreaseCritRate((Stat/3)+1.5);
					if (Type == 16) Player.DecreaseCritDamage((Stat/2)+1.5);
					if (Type == 18) Player.RemoveMinAttack(((MinMAtk*Stat)/90)+0.5);
					if (Type == 19) Player.RemoveMaxAttack(((MaxMAtk*Stat)/90)+0.5);
					if (Type == 20) Player.CancelBuff(298);
					if (Type == 21) Player.CancelBuff(330);
				}
				...
				if (Stat && Mirror.CheckIndex() == 3383)
				{
					...
					if (Type == 5) Player.RemoveOTP(((Otp*Stat)/80)+0.5);
					if (Type == 6) Player.RemoveEva(((Eva*Stat)/80)+0.5);
					if (Type == 7) Player.RemoveDef(Stat+2.5);
					if (Type == 10) Player.DecreaseMaxHp(((HpPoint*Stat)/80)+0.5);
					if (Type == 11) Player.DecreaseMaxMp(((MpPoint*Stat)/80)+0.5);
					if (Type == 12) Player.DecreaseMovingSpeed((3*Stat)+2.5);
					if (Type == 13) Player.RemoveMinAttack(((MinPAtk*Stat)/80)+0.5);
					if (Type == 14) Player.RemoveMaxAttack(((MaxPAtk*Stat)/80)+0.5);
					if (Type == 15) Player.DecreaseCritRate((Stat/3)+2.5);
					if (Type == 16) Player.DecreaseCritDamage((Stat/2)+2.5);
					if (Type == 18) Player.RemoveMinAttack(((MinMAtk*Stat)/80)+0.5);
					if (Type == 19) Player.RemoveMaxAttack(((MaxMAtk*Stat)/80)+0.5);
					if (Type == 20) Player.CancelBuff(298);
					if (Type == 21) Player.CancelBuff(330);
				}
			}
			...
			if (Item.CheckIndex() >= 3018 && Item.CheckIndex() <= 3020)
			{
				if (Player.IsBuff(311) && Taegeuk.find(*(DWORD*)((int)Itemx + 32))->second)
				{
					...
					Player.RemoveMaxAttack(TaegeukPrefix[(Taegeuk.find(*(DWORD*)((int)Itemx + 32))->second - 1)][2]);
					Player.RemoveMinAttack(TaegeukPrefix[(Taegeuk.find(*(DWORD*)((int)Itemx + 32))->second - 1)][2]);
			...
			if (Item.CheckIndex() >= 2946 && Item.CheckIndex() <= 2948)
			{
				...
				Player.RemoveMaxAttack(TrigramAtk.find(*(DWORD*)((int)Itemx + 32))->second + ((TrigramAtk.find(*(DWORD*)((int)Itemx + 32))->second * YinYangRate[YinYangType][YinYangGrade]) / 100));
				Player.RemoveMinAttack(TrigramAtk.find(*(DWORD*)((int)Itemx + 32))->second + ((TrigramAtk.find(*(DWORD*)((int)Itemx + 32))->second * YinYangRate[YinYangType][YinYangGrade]) / 100));
			...
			if ((Item.CheckIndex() >= 1747 && Item.CheckIndex() <= 1762) || (Item.CheckIndex() >= 1870 && Item.CheckIndex() <= 1877) || (Item.CheckIndex() >= 2004 && Item.CheckIndex() <= 2007) || (Item.CheckIndex() >= 2421 && Item.CheckIndex() <= 2423) || (Item.CheckIndex() >= 2550 && Item.CheckIndex() <= 2653))
			{
	...
	if (Player.IsOnline())
	{
		...
		if (Item.CheckIndex() >= 3384 && Item.CheckIndex() <= 3386 && CheckHaninMirror.find(Player.GetPID())->second)
		{
			...
			if (Stat && Mirror.CheckIndex() == 3381)
			{
				...
				if (Type == 5) Player.AddOTP(((Otp*Stat)/100)+0.5);
				if (Type == 6) Player.AddEva(((Eva*Stat)/100)+0.5);
				if (Type == 7) Player.AddDef(Stat+0.5);
				if (Type == 10) Player.IncreaseMaxHp(((HpPoint*Stat)/100)+0.5);
				if (Type == 11) Player.IncreaseMaxMp(((MpPoint*Stat)/100)+0.5);
				if (Type == 12) Player.IncreaseMovingSpeed((3*Stat)+0.5);
				if (Type == 13) Player.AddMinAttack(((MinPAtk*Stat)/100)+0.5);
				if (Type == 14) Player.AddMaxAttack(((MaxPAtk*Stat)/100)+0.5);
				if (Type == 15) Player.IncreaseCritRate((Stat/3)+0.5);
				if (Type == 16) Player.IncreaseCritDamage((Stat/2)+0.5);
				if (Type == 18) Player.AddMinAttack(((MinMAtk*Stat)/100)+0.5);
				if (Type == 19) Player.AddMaxAttack(((MaxMAtk*Stat)/100)+0.5);
				if (Type == 20) Player.Buff(298,1296000,0);
				if (Type == 21) Player.Buff(330,1296000,0);
			}
			...
			if (Stat && Mirror.CheckIndex() == 3382)
			{
				...
				if (Type == 5) Player.AddOTP(((Otp*Stat)/90)+0.5);
				if (Type == 6) Player.AddEva(((Eva*Stat)/90)+0.5);
				if (Type == 7) Player.AddDef(Stat+1.5);
				if (Type == 10) Player.IncreaseMaxHp(((HpPoint*Stat)/90)+0.5);
				if (Type == 11) Player.IncreaseMaxMp(((MpPoint*Stat)/90)+0.5);
				if (Type == 12) Player.IncreaseMovingSpeed((3*Stat)+1.5);
				if (Type == 13) Player.AddMinAttack(((MinPAtk*Stat)/90)+0.5);
				if (Type == 14) Player.AddMaxAttack(((MaxPAtk*Stat)/90)+0.5);
				if (Type == 15) Player.IncreaseCritRate((Stat/3)+1.5);
				if (Type == 16) Player.IncreaseCritDamage((Stat/2)+1.5);
				if (Type == 18) Player.AddMinAttack(((MinMAtk*Stat)/90)+0.5);
				if (Type == 19) Player.AddMaxAttack(((MaxMAtk*Stat)/90)+0.5);
				if (Type == 20) Player.Buff(298,1296000,0);
				if (Type == 21) Player.Buff(330,1296000,0);
			}
			...
			if (Stat && Mirror.CheckIndex() == 3383)
			{
				...
				if (Type == 5) Player.AddOTP(((Otp*Stat)/80)+0.5);
				if (Type == 6) Player.AddEva(((Eva*Stat)/80)+0.5);
				if (Type == 7) Player.AddDef(Stat+2.5);
				if (Type == 10) Player.IncreaseMaxHp(((HpPoint*Stat)/80)+0.5);
				if (Type == 11) Player.IncreaseMaxMp(((MpPoint*Stat)/80)+0.5);
				if (Type == 12) Player.IncreaseMovingSpeed((3*Stat)+2.5);
				if (Type == 13) Player.AddMinAttack(((MinPAtk*Stat)/80)+0.5);
				if (Type == 14) Player.AddMaxAttack(((MaxPAtk*Stat)/80)+0.5);
				if (Type == 15) Player.IncreaseCritRate((Stat/3)+2.5);
				if (Type == 16) Player.IncreaseCritDamage((Stat/2)+2.5);
				if (Type == 18) Player.AddMinAttack(((MinMAtk*Stat)/80)+0.5);
				if (Type == 19) Player.AddMaxAttack(((MaxMAtk*Stat)/80)+0.5);
				if (Type == 20) Player.Buff(298,1296000,0);
				if (Type == 21) Player.Buff(330,1296000,0);
			}
		}
		...
		if (Item.CheckIndex() >= 3018 && Item.CheckIndex() <= 3020 && !Taegeuk.find(*(DWORD*)((int)Itemx + 32))->second)
		{
			...
			if (Player.IsBuff(311) && Taegeuk.find(*(DWORD*)((int)Itemx + 32))->second)
			{
				...
				Player.AddMaxAttack(TaegeukPrefix[(Taegeuk.find(*(DWORD*)((int)Itemx + 32))->second - 1)][2]);
				Player.AddMinAttack(TaegeukPrefix[(Taegeuk.find(*(DWORD*)((int)Itemx + 32))->second - 1)][2]);
			...
			&& TrigramHth.find(*(DWORD*)((int)Itemx + 32))->second)
		{
			...
			Player.AddMaxAttack(TrigramAtk.find(*(DWORD*)((int)Itemx + 32))->second + ((TrigramAtk.find(*(DWORD*)((int)Itemx + 32))->second * YinYangRate[YinYangType][YinYangGrade]) / 100));
			Player.AddMinAttack(TrigramAtk.find(*(DWORD*)((int)Itemx + 32))->second + ((TrigramAtk.find(*(DWORD*)((int)Itemx + 32))->second * YinYangRate[YinYangType][YinYangGrade]) / 100));
...
int __fastcall ItemOnTimer(int Item, void *edx, int Argument)
{
	...
	if (!CBase::IsDeleted(Item) && ((IItem.CheckIndex() >= 1747 && IItem.CheckIndex() <= 1762) || (IItem.CheckIndex() >= 1870 && IItem.CheckIndex() <= 1877) || (IItem.CheckIndex() >= 2004 && IItem.CheckIndex() <= 2007) || (IItem.CheckIndex() >= 2421 && IItem.CheckIndex() <= 2423) || (IItem.CheckIndex() >= 2550 && IItem.CheckIndex() <= 2653)))
	{
		IChar IPlayer((void*)PetLifeCheck.find(IItem.GetIID())->second.Player);

		if (!CBase::IsDeleted(Item) && IPlayer.IsOnline() && PetLifeCheck.count(IItem.GetIID()) && (int)time(0) + 3 >= PetLifeCheck.find(IItem.GetIID())->second.Time)
		{
			*(DWORD*)(Item + 68) = 0;
	...
	if (!CBase::IsDeleted(Item))
	{
		...
		if (!CBase::IsDeleted(Item) && IPlayer.IsOnline() && PetLifeCheck.count(IItem.GetIID()) && (int)time(0) >= PetLifeCheck.find(IItem.GetIID())->second.Time)
		{
			*(DWORD*)(Item + 68) = 0;
			int MyItem = IItem.GetItemPointerFromIID(IPlayer.GetOffset(),IItem.GetIID());
...
signed int __fastcall OrnamentChangePrefix(void *Item, void* _edx, int Player, int ID, int Chance, int Argument)
{
	...
	if (CurrentPrefix == NewPrefix)
	{
		...
		{
			if (WeaponReplace.find(IItem.CheckIndex())->second && WeaponReplace.find(IItem.CheckIndex())->second == NewPrefix)
			{
