static signed int (__cdecl *IsPlayerCheck)() = (signed int (__cdecl*)())0x00643C50;
static signed int (__cdecl *IsPlayerAttack)() = (signed int (__cdecl*)())0x00640C10;
static int (__thiscall *EndDashSkill)(int Player) = (int (__thiscall*)(int))0x0041A610;
static void *(__thiscall *SetTip)(int pTarget, LPCTSTR pString, COLORREF color, int dwLife, int bShowName) = (void *(__thiscall*)(int,LPCTSTR,COLORREF,int,int))0x00416D20;	
static int (__thiscall *PlayerTick)(void *pTarget, unsigned int Value) = (int (__thiscall*)(void*,unsigned int))0x00404070;
static signed int (__cdecl *SkillButton)(int Value) = (signed int (__cdecl*)(int))0x00411710;
